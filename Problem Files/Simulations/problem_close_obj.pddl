...
(:init	
	...
	(= (printing_velocity vtx05 vtx00) 0.06)		
	(= (printing_velocity vtx10 vtx11) 0.08)
	(= (printing_velocity vtx11 vtx12) 0.06)
	(= (printing_velocity vtx12 vtx13) 0.08)
	(= (printing_velocity vtx13 vtx14) 0.06)
	(= (printing_velocity vtx14 vtx15) 0.08)
	(= (printing_velocity vtx15 vtx10) 0.06)	
	(= (link_length vtx00 vtx01) 1.4)
	(= (link_length vtx01 vtx02) 0.2)
	(= (link_length vtx02 vtx03) 0.5)
	(= (link_length vtx03 vtx04) 0.1)
	(= (link_length vtx04 vtx05) 0.9)
	(= (link_length vtx05 vtx00) 0.3)
	(= (link_length vtx10 vtx11) 1.4)
	(= (link_length vtx11 vtx12) 0.2)
	(= (link_length vtx12 vtx13) 0.5)
	(= (link_length vtx13 vtx14) 0.1)
	(= (link_length vtx14 vtx15) 0.9)
	(= (link_length vtx15 vtx10) 0.3)
